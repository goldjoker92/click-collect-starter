            ...
            <div className="col-md-6 mt-5 mt-md-2 text-center text-md-left">
              ...
              <div className="row mt-4">
                <div className="col-6">
                  ...
                  <select value='small' name="size" id="size" className="custom-select htmlForm-control  mb-4">
                ...
                <div className="col-6">
                  ...
                  <input value='1'  id="quantity" name="quantity" type="number" className="htmlForm-control quantity  mb-4" />
                </div>
              </div>
